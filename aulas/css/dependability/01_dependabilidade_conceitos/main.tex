...
\begin{minipage}[t]{0.75\textwidth}
    \begin{center}
        ...
        \raisebox{2ex}{\LARGE\bfseries\textcolor{blue}{Conceitos Básicos}}\\
    \end{center}
\end{minipage}
...
% =========================================================
\section{Overview Dependabilidade}

\begin{frame}{Mapa das 3 aulas}
\centering
\resizebox{0.96\textwidth}{!}{%
\begin{tikzpicture}[>=Stealth, node distance=6mm]
  \node[draw, rounded corners, align=center, minimum width=0.86\textwidth, fill=blue!6] (a1)
  {\textbf{Aula 1}\\
  ...
  \node[draw, rounded corners, align=center, minimum width=0.86\textwidth, below=of a1, fill=green!6] (a2)
  {\textbf{Aula 2}\\
   \small Confiabilidade e Disponibilidade: modelos probabilísticos, hazard, Weibull, composição (RBD/Markov), SLO/SLI
  };

  \node[draw, rounded corners, align=center, minimum width=0.86\textwidth, below=of a2, fill=red!6] (a3)
  {\textbf{Aula 3}\\
...
\begin{frame}{Objetivos técnicos da aula}
...
\begin{frame}{Fault, Error, Failure}
\begin{description}
